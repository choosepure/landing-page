...
const REPORTS = [
  ...
  {
    // Organic Tattva Cold Pressed Sunflower Oil - find by productName
    findBy: { productName: /Organic Tattva.*Sunflower/i },
    update: {
      productName: 'Organic Tattva Cold Pressed Sunflower Oil',
      brandName: 'Mehrotra Consumer Products Pvt. Ltd.',
      category: 'Edible Oil · Cold Pressed Sunflower',
      labName: 'FARE Labs Pvt. Ltd. (TC-5503), Gurugram',
      labReportNumber: 'O&F20260320-018-040',
      reportDate: new Date('2026-03-25'),
      testDate: new Date('2026-03-20'),
      batchCode: 'OT86SNS1125',
      sampleCondition: 'Good · 1L sealed PET bottle',
      totalParametersTested: 88,
      origin: 'Greater Noida',
      purityScore: 90,
      scoreVerdict: 'Excellent',
      scoreFormula: 'Started 100; −5 limited pesticide panel (8 compounds); −3 TC-5503 vs full NABL; −2 no peroxide value / Vitamin E data. Final: 90',
      categoryScores: [
        { categoryName: 'Synthetic Antioxidants', score: 100, description: 'No TBHQ, BHA, or gallates — all ND (cold press needs none)' },
        { categoryName: 'Cold-Press Verification', score: 100, description: 'Hexane residues ND — solvent-free extraction confirmed' },
        { categoryName: 'Heavy Metals', score: 100, description: '8 metals — all below quantification limit' },
        { categoryName: 'Aflatoxins', score: 100, description: 'B1 & Total — both ND at 1 µg/kg LOQ' },
        { categoryName: 'Pesticide Residues', score: 85, description: '8 compounds — all BLQ (panel limited vs 140+ elsewhere)' },
        { categoryName: 'Colours & Additives', score: 100, description: '20 colour additives + preservatives — all absent' },
        { categoryName: 'Fatty Acid Authenticity', score: 100, description: '21-acid profile confirms genuine sunflower oil, zero trans fats' },
      ],
      testParameters: {
        'Chemical Quality': [
          { parameterName: 'Hexane Residues', result: 'ND (DL 0.5)', unit: 'mg/kg', fssaiLimit: 'NMT 5.0 mg/kg', euLimit: '≤ 1 mg/kg (cold-pressed)', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Acid Value', result: '2.83', unit: 'mg KOH/g', fssaiLimit: 'NMT 6', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Iodine Value', result: '118.52', unit: '', fssaiLimit: '100–145', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Flash Point', result: '284', unit: '°C', fssaiLimit: 'NLT 250°C', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Refractive Index', result: '1.4659', unit: '', fssaiLimit: '1.4640–1.4691', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Saponification Value', result: '190.55', unit: '', fssaiLimit: '188–194', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Unsaponifiable Matter', result: '0.82', unit: '%', fssaiLimit: 'NMT 1.5%', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Argemone Oil (TLC)', result: 'Negative', unit: '', fssaiLimit: 'Absent', euLimit: 'Absent', usFdaLimit: 'Absent', status: 'Pass' },
        ],
        'Heavy Metals': [
          { parameterName: 'Arsenic', result: 'BLQ (LOQ 0.02)', unit: 'mg/kg', fssaiLimit: 'NMT 0.1 mg/kg', euLimit: '0.1 mg/kg', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Lead', result: 'BLQ (LOQ 0.02)', unit: 'mg/kg', fssaiLimit: 'NMT 0.1 mg/kg', euLimit: '0.1 mg/kg', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Cadmium', result: 'BLQ (LOQ 0.02)', unit: 'mg/kg', fssaiLimit: 'NMT 1.5 mg/kg', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Mercury + Methyl Mercury', result: 'BLQ (LOQ 0.02)', unit: 'mg/kg', fssaiLimit: 'NMT 1.0 mg/kg', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Copper', result: 'BLQ (LOQ 0.05)', unit: 'mg/kg', fssaiLimit: 'NMT 30.0 mg/kg', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Tin + Zinc', result: 'BLQ', unit: 'mg/kg', fssaiLimit: 'NMT 250 mg/kg (Tin)', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
        ],
        'Aflatoxins': [
          { parameterName: 'Aflatoxin B1', result: 'BLQ (LOQ 1)', unit: 'µg/kg', fssaiLimit: 'NMT 10 µg/kg', euLimit: '≤ 2 µg/kg', usFdaLimit: '≤ 20 µg/kg (total)', status: 'Pass' },
          { parameterName: 'Total Aflatoxins (B1+B2+G1+G2)', result: 'BLQ (LOQ 1)', unit: 'µg/kg', fssaiLimit: 'NMT 15 µg/kg', euLimit: '≤ 4 µg/kg', usFdaLimit: '≤ 20 µg/kg', status: 'Pass' },
        ],
        'Pesticide Residues': [
          { parameterName: 'Cypermethrin', result: 'BLQ (LOQ 0.01)', unit: 'mg/kg', fssaiLimit: 'NMT 0.2', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Imidacloprid', result: 'BLQ (LOQ 0.01)', unit: 'mg/kg', fssaiLimit: 'NMT 0.5', euLimit: 'Restricted', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Carbofuran', result: 'BLQ (LOQ 0.01)', unit: 'mg/kg', fssaiLimit: 'NMT 0.1', euLimit: 'Banned', usFdaLimit: 'Banned', status: 'Pass' },
          { parameterName: 'Phorate', result: 'BLQ (LOQ 0.01)', unit: 'mg/kg', fssaiLimit: 'NMT 0.05', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Oxadiargyl', result: 'BLQ (LOQ 0.01)', unit: 'mg/kg', fssaiLimit: 'NMT 0.05', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Phenthoate', result: 'BLQ (LOQ 0.01)', unit: 'mg/kg', fssaiLimit: 'NMT 0.01', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Permethrin', result: 'BLQ (LOQ 0.01)', unit: 'mg/kg', fssaiLimit: 'NMT 1', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Trichlorfon', result: 'BLQ (LOQ 0.01)', unit: 'mg/kg', fssaiLimit: 'NMT 0.05', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
        ],
        'Additives & Colours': [
          { parameterName: 'Synthetic Colours (8 types)', result: 'Absent', unit: '', fssaiLimit: 'Not permitted in oil', euLimit: 'Restricted', usFdaLimit: 'Restricted', status: 'Pass' },
          { parameterName: 'Natural Colours (12 types)', result: 'Absent', unit: '', fssaiLimit: 'Declared if added', euLimit: 'Declared if added', usFdaLimit: 'Declared if added', status: 'Pass' },
          { parameterName: 'Potassium Bromate', result: 'Absent', unit: '', fssaiLimit: 'Banned', euLimit: 'Banned', usFdaLimit: 'Banned', status: 'Pass' },
          { parameterName: 'BHA + Gallates (5 types)', result: 'ND/BLQ', unit: '', fssaiLimit: 'Permitted (not used)', euLimit: 'Permitted', usFdaLimit: 'Permitted', status: 'Pass' },
          { parameterName: 'Benzoic + Sorbic Acid', result: 'ND', unit: '', fssaiLimit: 'Not permitted in oil', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
        ],
        'Fatty Acid Profile': [
          { parameterName: 'Linoleic Acid (C18:2, Omega-6)', result: '50.38', unit: '%', fssaiLimit: '48.3–74%', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Oleic Acid (C18:1, Omega-9)', result: '38.31', unit: '%', fssaiLimit: '14–39.4%', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Palmitic Acid (C16:0)', result: '5.50', unit: '%', fssaiLimit: 'Characteristic', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Stearic Acid (C18:0)', result: '3.86', unit: '%', fssaiLimit: 'Characteristic', euLimit: 'Not specified', usFdaLimit: 'Not specified', status: 'Pass' },
          { parameterName: 'Trans Fatty Acids (Total)', result: 'ND', unit: '%', fssaiLimit: 'NMT 2%', euLimit: '≤ 2%', usFdaLimit: 'Labelling required', status: 'Pass' },
        ],
      },
      stats: { totalParameters: 88, passCount: 88, contextNotes: 0, safetyConcerns: 0 },
      parentSummary: 'Organic Tattva Cold Pressed Sunflower Oil scores 90/100 — an Excellent rating and the cleanest edible oil in the ChoosePure series so far. 88+ parameters across 12 categories all pass. No synthetic antioxidants (no TBHQ, BHA or gallates), hexane-free cold press independently confirmed, zero trans fats, and clean heavy metals, aflatoxins and pesticides. The high omega-6 content (50.38% linoleic acid) is normal for sunflower oil — a nutrition consideration (rotate with lower-omega-6 oils), not a safety concern.',
      expertCommentary: 'This is the most comprehensively tested cooking oil we have reviewed. The hexane ND result independently verifies the cold-pressed claim, and the complete absence of synthetic antioxidants stands in sharp contrast to Fortune Rice Bran Oil (TBHQ at 190 ppm). Minor gaps: the pesticide panel covers only 8 compounds (vs 140+ in the SGS egg report), peroxide value is not reported, and FARE Labs TC-5503 is accredited but not full NABL.',
      methodology: 'Third-party analysis at FARE Labs Pvt. Ltd. (TC-5503), Gurugram. 88+ parameters across 12 categories: chemical quality, heavy metals, aflatoxins, pesticides, colours, additives, and a 21-acid fatty acid profile. Standards: FSSAI FSS Regulations 2011 Schedule 2; EU Reg EC 1881/2006 & Directive 95/2/EC; US FDA 21 CFR.',
      isPremium: true,
      reportUrl: '/organic-tattva-cold-pressed-sunflower-oil-report.html',
      statusBadges: ['FARE Labs TC-5503', 'No synthetic antioxidants', 'Cold-press verified'],
    }
  },
];
